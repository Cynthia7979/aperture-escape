        ...
        GeometryReader { metric in
            ScrollView {
                VStack {
                    ...
                    Text("With a crowbar out of nowhere, you broke it open and crawled inside. Fortunately, the neurotoxin floated high in the air, so you are safe from being suffocated here.")
                    .padding()
